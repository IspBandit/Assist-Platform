...
</div><div class="footer-bottom"><p>&copy; <?= date('Y') ?> <?= $this->e($footerBrand->legalName()) ?><?php if ($bizAbn !== ''): ?> · ABN <?= $this->e($bizAbn) ?><?php endif; ?>. Information is general only; verify specifications, suitability and licensing where required.</p></div></div></footer>
