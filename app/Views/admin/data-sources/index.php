...
<div class="page-header"><div><p class="eyebrow">Platform Control Centre</p><h1>Data sources</h1><p class="muted">Discover gaps through pluggable connectors. Nothing becomes public until it passes the review queue.</p></div><div class="btn-row"><a class="btn btn-secondary" href="<?= e(url('admin/qld-coverage')) ?>">Queensland coverage</a><a class="btn btn-primary" href="<?= e(url('admin/data-sources/review')) ?>">Open review queue</a></div></div>
