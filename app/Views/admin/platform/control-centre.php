...
<section class="section-compact">
    ...
    <div class="platform-brand-grid">
        ...
        <article class="card platform-brand-card" style="--tenant-colour:<?= e($theme['brand'] ?? '#0f6e6e') ?>">
            <div class="platform-brand-title"><img src="<?= e($brand->url() . ($assets['logo'] ?? '/assets/brands/vanassist/mark.svg')) ?>" alt="" width="48" height="48"><div><h3><?= $this->e($brand->name()) ?></h3><p class="muted"><?= $this->e($brand->status()) ?> · <?= $this->e($brand->primaryDomain()) ?></p></div></div>
