...
<section class="card social-studio-create">
    <div><h2>Create a campaign asset</h2><p class="muted">Every graphic uses <?= $this->e($brand->name()) ?> colours, premium imagery, its own domain and the platform's exact recommended dimensions.</p></div>
        ...
        <?php foreach ($assets as $asset): ?>
            <article class="card social-asset-card">
                ...
                <div class="social-asset-body">
                    <div class="social-meta"><span class="badge"><?= $this->e(ucfirst((string) $asset['platform'])) ?></span><span class="badge badge-muted"><?= (int) $asset['width'] ?>×<?= (int) $asset['height'] ?></span><span class="badge status-<?= e((string) $asset['status']) ?>"><?= $this->e(ucfirst((string) $asset['status'])) ?></span></div>
