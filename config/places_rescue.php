 ...
 *
 * Each category may list several query phrases (tried in order, budget-gated).
 * A string value is treated as a single-phrase list.
 */
return [
    'weak_result_threshold' => 3,
    /** Results within this distance (km) are described as “for this area”. */
    'local_radius_km' => 50,
    'max_results' => 8,
    ...
    'queries' => [
        'refrigeration' => [
            'fridge refrigeration repair caravan RV',
            'appliance fridge repair',
            'refrigeration mechanic',
        ],
        'air-conditioning' => [
            'caravan air conditioning repair',
            'air conditioning repair',
        ],
        'gas-appliance-servicing' => [
            'caravan gas appliance refrigeration',
            'gas appliance repair',
        ],
        'appliance-repairs' => [
            'caravan appliance repair',
            'appliance repair',
        ],
        'general-caravan-repairs' => [
            'caravan repairs RV service',
            'caravan repair workshop',
        ],
        'mobile-mechanics' => [
            'mobile caravan mechanic',
            'mobile mechanic',
        ],
        'mechanical-repairs' => [
            'caravan mechanical repairs',
            'mechanical repairs workshop',
        ],
        'diesel-mechanics' => [
            'mobile diesel mechanic caravan',
            'diesel mechanic',
        ],
        'auto-electrical-and-batteries' => [
            'auto electrician caravan 12 volt',
            'auto electrician',
        ],
        '12-volt-electrical' => [
            'caravan 12 volt auto electrician',
            '12 volt auto electrician',
        ],
