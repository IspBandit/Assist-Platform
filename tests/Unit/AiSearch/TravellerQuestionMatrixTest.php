...
final class TravellerQuestionMatrixTest extends TestCase
{
    ...
    public static function commonQuestions(): array
    {
        return [
            ...
            'flat battery' => ['my caravan battery will not charge near Emerald', Intent::TYPE_PROVIDER, 'provider', 'solar-and-batteries'],
            'hot water' => ['no hot water in the caravan near Mackay', Intent::TYPE_PROVIDER, 'provider', 'hot-water-systems'],
            'blocked toilet' => ['blocked caravan toilet near Roma', Intent::TYPE_PROVIDER, 'provider', 'toilets'],
            'broken spring' => ['broken leaf spring on my caravan near Winton', Intent::TYPE_PROVIDER, 'provider', 'suspension'],
            'cracked chassis' => ['cracked chassis near Dubbo', Intent::TYPE_PROVIDER, 'provider', 'structural-repairs'],
            'fibreglass' => ['cracked fibreglass caravan panel near Cairns', Intent::TYPE_PROVIDER, 'provider', 'fibreglass-repairs'],
            'starlink' => ['starlink not working near Longreach', Intent::TYPE_PROVIDER, 'provider', 'starlink-and-communications'],
            'insurance' => ['need an insurance repairer in Brisbane', Intent::TYPE_PROVIDER, 'provider', 'insurance-repairs'],
            'pre trip' => ['need a pre trip inspection near Toowoomba', Intent::TYPE_PROVIDER, 'provider', 'pre-trip-inspection'],
            'roadworthy' => ['need a roadworthy in Bundaberg', Intent::TYPE_PROVIDER, 'provider', 'roadworthy-inspection'],
            'pet emergency' => ['need a vet near Emerald', Intent::TYPE_PROVIDER, 'provider', 'pet-friendly-travel-and-veterinary'],
            'remote recovery' => ['bogged in sand near Rainbow Beach', Intent::TYPE_PROVIDER, 'provider', '4wd-and-remote-area-recovery'],
            'windscreen' => ['broken windscreen near Roma', Intent::TYPE_PROVIDER, 'provider', 'windscreen-and-auto-glass'],
            'parts' => ['need caravan spare parts in Mackay', Intent::TYPE_PROVIDER, 'provider', 'caravan-and-rv-parts'],
            'towbar' => ['need a towbar fitter near Gladstone', Intent::TYPE_PROVIDER, 'provider', 'towing-equipment-and-accessories'],
            'weigh caravan' => ['where can I weigh my caravan near Gympie', Intent::TYPE_PROVIDER, 'provider', 'weighbridges-and-mobile-weighing'],
            'caravan wash' => ['caravan wash near Rockhampton', Intent::TYPE_PROVIDER, 'provider', 'vehicle-and-caravan-washing'],
            'storage' => ['need caravan storage near Cairns', Intent::TYPE_PROVIDER, 'provider', 'caravan-storage'],
            'welder' => ['need a mobile welder near Emerald', Intent::TYPE_PROVIDER, 'provider', 'mobile-welding-and-fabrication'],
        ];
    }
