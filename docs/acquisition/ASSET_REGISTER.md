...
| `IspBandit/assist-ric` | Shared/confirm | Research/import management client used with the Admin API | Confirm whether included, licensed or retained; document any required operational dependency |
...
- source-code/IP ownership statement;
...
2. obtain the authoritative source and build it from a clean checkout;
...
6. create and revoke administrators without founder assistance; and
7. operate VanAssist, TowSmart and TrailerWise without any LocalTorque, Polaris or founder-workstation dependency.
