...
$articles = [
    $common('customer-guide', 'finding-nearby-help', 'Finding nearby help', 'Search VanAssist by service and location, compare mapped results and open directions safely.', ['customer'], ['vanassist'], 'search', 5, [], ['/find'], ['customer-guide.requests-and-saved-providers'], ['routes/web.php', 'app/Controllers/Site/SearchController.php', 'app/Controllers/Site/HomeController.php', 'app/Views/public/home.php', 'app/Views/public/search-results.php', 'public/assets/js/app.js']),
    $common('customer-guide', 'towsmart-trailerwise-navigation', 'TowSmart and TrailerWise navigation', 'Use brand header CTAs, footer actions and save-to-phone controls on TowSmart and TrailerWise.', ['customer'], ['towsmart', 'trailerwise'], 'navigation', 7, [], ['/', '/calculator', '/providers', '/services', '/marketplace', '/manifest.webmanifest'], ['customer-guide.account-and-garage'], ['app/Models/BrandProviderCategory.php', 'app/Controllers/Site/CategoryController.php', 'app/Views/brands/service-categories.php', 'app/Views/partials/header.php', 'app/Views/partials/footer.php', 'app/Views/layouts/public.php', 'app/Controllers/Site/AssetController.php', 'public/assets/js/app.js']),
    ...
    $common('administrator-guide', 'growth-and-campaigns', 'Growth and campaigns', 'Operate prospects, the evidence-backed PR & Outreach Hub, Social Studio and staged email campaigns.', ['administrator'], $allBrands, 'growth', 40, ['prospects.manage', 'content.manage', 'notifications.send'], ['/admin/prospects', '/admin/outreach-hub', '/admin/social-media', '/admin/notifications'], ['administrator-guide.content-and-seo', 'administrator-guide.insights-and-data'], ['routes/admin.php', 'app/Controllers/Admin/ProspectsController.php', 'app/Controllers/Admin/OutreachHubController.php', 'app/Controllers/Admin/SocialMediaController.php', 'app/Controllers/Admin/NotificationsController.php', 'app/Services/OrganisationOutreach.php', 'app/Services/NotificationService.php']),
    $common('administrator-guide', 'insights-and-data', 'Insights and data operations', 'Use brand-scoped demand/Data Intelligence, VanAssist growth and trust operations, global trust review, and platform-owned brand-mapped Data Sources.', ['administrator'], $allBrands, 'insights', 50, ['demand.view', 'demand.export', 'data_intelligence.view', 'data_intelligence.manage', 'regulatory.manage', 'campaigns.manage', 'data_sources.view'], ['/admin/demand', '/admin/data-intelligence', '/admin/growth-trust', '/admin/trust-growth', '/admin/data-sources'], ['administrator-guide.providers-and-directory', 'administrator-guide.growth-and-campaigns'], ['routes/admin.php', 'app/Controllers/Admin/DemandController.php', 'app/Controllers/Admin/GrowthTrustController.php', 'app/Controllers/Admin/DataIntelligenceController.php', 'app/Controllers/Admin/TrustGrowthController.php', 'app/Controllers/Admin/DataSourcesController.php']),
