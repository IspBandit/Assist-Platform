...
- **Free Growth Hub:** brings the no-cost audience channels together: provider factual notices, reviewed organisation outreach, Social Studio, Facebook Page/manual community sharing, provider and park referrals, Google/Bing indexing and everyday personal sharing. Channel cards show the current factual-campaign, organisation, Facebook, indexing and approved-asset status. The tracked share kit supplies separate community, Messenger, club-newsletter and partner links plus ready-to-copy wording. Website Insights displays these sources in plain English.
- **Organisation outreach:** headline measures show organisation targets needing review, send-eligible targets, follow-ups due, messages accepted by the configured mail transport and positive outcomes. The target register preserves review basis/evidence and reviewer date. Recent outreach history is append-only across queued, sent, failed, suppressed and human outcome events.
...
- **Campaign list/compose:** open **Growth → Email campaigns** directly. Every existing campaign has its actual next action in the list: **Send preview to me**, **Start sending (max 25)**, **Send next batch** or **View results**. **Review details** remains available when you need recipient or delivery evidence. New campaigns use **Create email campaign**, **Apply starter**, **Preview recipients** and **Save staged campaign**.
...
- **Free Growth Hub organisation email actions:** use the explicit **Email clubs and organisations** shortcut, then choose **Caravan and RV clubs**, **Club federations**, **4WD and touring clubs**, **Publications and media**, **Tourism organisations**, **Industry associations**, **Manufacturers**, **Dealers and sales networks**, **Rental fleets and marketplaces** or **Caravan park networks**. Each card shows its reviewed send-eligible count. **Create email campaign** opens a campaign with the exact organisation type, audience, subject and matching human message already filled in; **Review contacts** opens the matching research queue.
- **Organisation target register:** download the evidence CSV template, import research for review, filter targets, open official sources, mark research/held/eligible/do-not-contact and record the exact eligibility basis and evidence. Record sent, replied, interested, shared, declined, bounced or opted-out outcomes and an optional next follow-up. Opt-out immediately adds marketing suppression.
- **Free Growth Hub:** copy a channel-specific message or tracked link, use the phone/tablet native share sheet, open Social Studio, check SEO settings, open Google Search Console or Bing Webmaster Tools, and open Website Insights to compare resulting visits. Group posts remain manual so the administrator can check each group’s rules and seek approval where required.
...
2026-07-30 (Free Growth Hub, tracked share kit and reviewed organisation campaigns).
