...
| VAN-011 | Flagship natural-language search (intent → location/category → reviewed results) | in progress | Radius ladder + Places rescue landed; Charters Towers fridge coverage fixed locally (migrations 138–139 + Places bootstrap); production Places enablement and flagship QG remain |
