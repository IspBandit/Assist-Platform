...
| VAN-011 | Flagship natural-language search (intent → location/category → reviewed results) | in progress | Radius ladder + surrounding-town fill when under 3 matches + Places rescue; production Places enablement and flagship QG remain |
