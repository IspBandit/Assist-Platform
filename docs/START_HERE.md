...
12. For Assist AI Search and Knowledge Orchestration (CORE-012 / VAN-011 /
    DATA-013): `docs/PHASE_AI0_DESIGN.md`, `docs/AI0_OWNER_DECISION_BRIEF.md`,
    `docs/AI_ORCHESTRATOR.md`, `docs/NATURAL_LANGUAGE_SEARCH.md`, ADRs
    0018–0027. AI-1 deterministic foundation: `App\Platform\AiSearch`,
    `/ask`, flag `assist_ai_search` (off by default). Do not change Admin API
