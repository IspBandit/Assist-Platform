...
- **RIC Increment I** — ops failed email/scheduled-task reads; categories +
  locations taxonomy reads (in flight / this PR)
...
- Stale/missing quality list Admin API (needs product list criteria)
- Feature-flag **writes**; provider hold/confirm/auto-link remain website admin

## Current task

1. ~~RIC everyday management A–H.4~~ — merged
2. ~~Increment I (ops + taxonomy reads)~~ — this change set
3. Owner/ops staging enablement + Quality Gate — **not authorised by code alone**

## Overall Completion %
96% programme; RIC everyday management A–H.4 complete; Increment I closing ops/taxonomy gaps
